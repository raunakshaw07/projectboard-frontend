...
const CreateTaskModal = ({ open, handleClose, projectId }) => {
    const [values, setValues] = useState({ lane: '', title: '', desc: '' });
    ...
    const handleSubmit = async (e) => {
        ...
        if (handleValidation()) {
            ...
            const { data } = await axios.post(createTaskRoute, newTask)
            if (data.status) {
                setValues({ lane: '', title: '', desc: '' });
                handleClose()
            } else {
    ...
    return (
        <div>
            ...
            >
                <Box sx={style.box}>
                    <Typography variant='h4' component='h4' sx={style.cardHead}>Add Task</Typography>
                    <hr width-='90%' />
                    <form style={style.form} onSubmit={handleSubmit}>
                        ...
                        <CssTextField
                            ...
                            onChange={(e) => handleChange(e)}
                        />
                        <SubmitButton type='submit' size='large' variant="contained">Add</SubmitButton>
                    </form>
                </Box>
            </Modal>
        </div>
